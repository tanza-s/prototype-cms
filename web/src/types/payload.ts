 ...
 *
 * ../lib/cms.ts picks the renditions generated by the `imageSizes` config in
 * cms/src/collections/Media.ts, so nothing downstream ever handles the original —
...
export interface EmbedBlock {
  ...
  title: string
  /** Per-placement heading, shown above the embed. */
  heading: string | null
